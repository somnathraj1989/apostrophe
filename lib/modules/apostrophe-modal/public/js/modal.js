...
apos.define('apostrophe-modal', {
  ...
  construct: function(self, options) {
    ...
    self.enableLifecycleEvents = function() {
      ...
      self.parentOnBeforeUnload = window.onbeforeunload;
    ...
    self.resizeContentHeight = function() {
      ...
      var headerHeight = $container.find('.apos-modal-header').outerHeight(),
          breadcrumbHeight = $container.find('.apos-modal-breadcrumb').outerHeight(),
          footerHeight = $container.find('.apos-modal-footer').outerHeight();
    ...
    self.confirmCancel = function(callback) {
      ...
      apos.confirm(self.$slideableAncestorEl, self.getConfirmCancelText(), function () {
        return callback;
      }, 'This is for real.');
    ...
    self.hide = function() {
      window.onbeforeunload = self.parentOnBeforeUnload;
